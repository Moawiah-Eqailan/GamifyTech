...
<title>Change Password | GamifyTech</title>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-xl-8">
                ...
                <div class="tab-pane" id="settings">
                    <form action="includes/user_edit_pass.php" method="POST">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="userpassword_old">Enter Old Password</label>
                                    <input type="password" class="form-control" id="userpassword_old" name="userpassword_old" placeholder="Enter old password" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="userpassword_new">Enter New Password</label>
                                    <input type="password" class="form-control" id="userpassword_new" name="userpassword_new" placeholder="Enter new password" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="userpassword_confirm">Confirm New Password</label>
                                    <input type="password" class="form-control" id="userpassword_confirm" name="userpassword_confirm" placeholder="Confirm new password" required>
                                </div>
                            </div>
                        </div>
